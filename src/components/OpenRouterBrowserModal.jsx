    ...
    <div className="w-full text-left px-4 py-3 border-b border-slate-800/50 transition-all hover:bg-slate-800/40 flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0 overflow-hidden">
        ...
        <div className="flex items-center gap-2 mt-0.5">
          ...
          <span className="text-[10px] text-slate-600 truncate hidden sm:block min-w-0 font-mono">
            {model.id}
          </span>
        </div>
      </div>
      ...
      <Button
        ...
        className={
          isAdded
            ? 'border-slate-600 text-slate-500 cursor-default h-8 w-8 p-0 shrink-0'
            : 'bg-purple-600 hover:bg-purple-500 text-white h-8 w-8 p-0 shrink-0'
        }
      >
...
export default function OpenRouterBrowserModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="bg-slate-900 border-purple-900/20 max-w-4xl w-[95vw] max-h-[90vh] overflow-hidden flex flex-col p-0 gap-0"
        onOpenAutoFocus={(e) => {
          e.preventDefault();
      ...
      >
        ...
        {/* Add by ID */}
        <div className="px-6 py-3 border-b border-slate-800 bg-amber-900/10 shrink-0">
